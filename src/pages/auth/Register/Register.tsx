...
export default function Register() {
  ...
  return (
    <div
      ...
      style={{
        // HUIT4 background image placed in the public folder as /huit4.jpg
    ...
    >
      <div className='w-full max-w-lg bg-white rounded-2xl shadow-lg p-10'>
        <h2 className='text-3xl font-bold text-center text-blue-600 mb-3'>Đăng ký tài khoản</h2>
        ...
        <form onSubmit={handleSubmit(onSubmit)} noValidate className='space-y-4'>
          ...
          <div className='relative'>
            ...
            <input
              ...
              {...register('password')}
              className={`w-full border rounded-lg px-4 py-3 pr-10 focus:outline-none focus:ring-2 focus:ring-blue-400 ${
