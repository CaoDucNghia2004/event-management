  ...
  return (
    ...
    >
      <div className='w-full max-w-lg bg-white rounded-2xl shadow-lg p-10'>
        {step === 'email' && (
          <>
            <h2 className='text-3xl font-bold text-center text-blue-600 mb-3'>Quên mật khẩu</h2>

            <div className='flex justify-center mb-6'>
              <img src='/logo1.jpg' alt='HUIT logo' className='h-20 w-auto rounded-full shadow-sm' />
            </div>

            <form onSubmit={handleSubmit(onSubmitEmail)} noValidate className='space-y-6'>
              <div className='relative'>
                <label htmlFor='email' className='block text-sm font-medium text-gray-700 mb-1'>
                  Nhập email của bạn
                </label>
        ...
        {step === 'reset' && (
          <form onSubmit={handleSubmitReset(onSubmitReset)} noValidate className='space-y-6'>
            <h2 className='text-3xl font-bold text-center text-green-600 mb-3'>Đặt lại mật khẩu</h2>
            <p className='text-gray-600 text-sm text-center mb-3'>
              Nhập lại email, mã khôi phục và mật khẩu mới để đặt lại tài khoản.
            </p>
            ...
            <div className='relative'>
              ...
              <div className='relative'>
                ...
                <input
                  ...
                  type='email'
                  {...registerReset('email')}
                  className={`w-full border rounded-lg pl-12 pr-4 py-3 focus:outline-none focus:ring-2 focus:ring-green-400 ${
                    errorsReset.email ? 'border-red-500' : 'border-gray-300'
                  }`}
                  placeholder='example@huit.edu.vn'
                />
            ...
            <div className='relative'>
              ...
              <div className='relative'>
                ...
                <input
                  ...
                  type={showPassword ? 'text' : 'password'}
                  {...registerReset('new_password')}
                  className={`w-full border rounded-lg pl-12 pr-12 py-3 focus:outline-none focus:ring-2 focus:ring-green-400 ${
                    errorsReset.new_password ? 'border-red-500' : 'border-gray-300'
                  }`}
                  placeholder='Nhập mật khẩu mới'
                />
            ...
            <div className='flex gap-2 mt-4 items-center'>
              <button
                type='submit'
                disabled={isSubmittingReset}
                className='flex-1 bg-green-600 text-white py-3 rounded-lg text-lg font-semibold hover:bg-green-700 transition disabled:opacity-60'
              >
                {isSubmittingReset ? 'Đang đặt lại...' : 'Xác nhận'}
              </button>
